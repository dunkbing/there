...
export function SoundSelector({ isOpen, onClose }: SoundSelectorProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-start">
      ...
      <div className="relative m-6 w-80 max-h-96 overflow-y-auto backdrop-blur-xl bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-2xl p-6 shadow-2xl animate-in slide-in-from-bottom-4 duration-300">
